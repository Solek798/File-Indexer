...
boost::program_options::options_description parse_options(int argc, char** argv);
int error_handling();
// debug functions
void print_options();
...
int main(const int argc, char** argv) {
    ...
    const int error_code = error_handling();
...
boost::program_options::options_description parse_options(const int argc, char** argv) {
